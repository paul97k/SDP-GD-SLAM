function f_MyMain4_create_outputMaps(obj_ID, cutIdx, folderDataPath, ...
    dataFolder_OutputMapSDP, dataFolder_OutputMapSonarBased, ...
    DataFileName, trusterInput, SDPOutputMapFilePathMain4)
...
%------------------------------------1. measurment data:  Set Measurement ------------------
    ...
    estimated_C_thetaFileMain4 = load(SDPOutputMapFilePathMain4);



    objSDP = classSDP_GD(A, B, dt, inputs, x_0, measurements, estimated_C_thetaFileMain4);
    ...
    estimated_C_theta      = estimated_C_thetaFileMain4.estimated_C_theta;
    nominalX               = estimated_C_thetaFileMain4.nominalX ;

    estimated_C_thetaDepth = objSDP.estimated_C_thetaDepth;
    nominalXdepth          = objSDP.nominalXdepth;
    ...
    save(CThetaFilePath', 'estimated_C_theta',  'estimated_C_thetaDepth', 'nominalX', 'nominalXdepth', 'timeElapse');
