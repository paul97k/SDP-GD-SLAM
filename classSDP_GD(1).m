classdef classSDP_GD < handle
    ...
    methods
        function obj = classSDP_GD(A, B, dt,  inputs, measurements, x_0)
            ...
            obj.estimated_C_theta_results = cell(1, length(measurements)); % Preallocate cell array
        ...
        %         [obj.nominalX, estimated_C_theta] = estimateCTheta(obj, obj.measurements{i}, obj.inputs, obj.dt, obj.A ,obj.B);
        %         obj.estimated_C_theta_results{i} = estimated_C_theta;
        %     end
        %     toc
        % end
        function obj = performSDP_GD(obj)
        ...
        function obj = mergeC(obj)
            ...
            obj.estimated_C_theta = zeros(size(xC,1)*3,size(xC,2));
            ...
            for i = 1:size(xC,1)
                ...
                y = yC(i,:);
                z = zC(i,:);
                obj.estimated_C_theta(i*3-2:i*3,:)=[x; y; z]; 
            end
