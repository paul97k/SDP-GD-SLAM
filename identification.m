...
obj = DataLoader(dataFolder_Chirp,ChirpFiles(2));
% obj.downSampleFreq = 0.5;
obj.downSampleFreq =2;
...
% 
Input = [objVal.CMD.cmd_linear_x*0  objVal.CMD.cmd_linear_y*0 objVal.CMD.cmd_linear_y*0 ...
         objVal.CMD.cmd_linear_x  objVal.CMD.cmd_linear_y objVal.CMD.cmd_linear_z];
...
figure;
hold on;
plot(t_sim, Input(:,4:6), 'LineWidth', 1.5); % Simulated output
...
legend('ref_v_x','ref_v_y', 'ref_v_z');
